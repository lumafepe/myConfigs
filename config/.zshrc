...
export ZSH="/home/luismfp/.oh-my-zsh"
...
plugins=(git z zsh-autosuggestions vscode colorize thefuck)
...
alias neovi="nvim"
alias neovim="nvim"
alias editNeovim="nvim ~/.config/nvim/init.vim"

#i3 config editor
alias i3conf="vim ~/.config/i3/config"
#polybar config editor
alias polyconf="code ~/.config/polybar"
#rofi config editor
alias roficonf="code ~/.config/rofi"


#its just funny
alias pls="sudo"

#auto-correction done easier
alias f="fuck"
